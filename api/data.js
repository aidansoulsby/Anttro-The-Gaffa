  ...
  try {
    ...
    const actionplanRows = actionplansData.map(r => {
      ...
      return {
        ...
        confirmedTimeLostHours: r['Confirmed Time Lost Hours'] ? parseFloat(r['Confirmed Time Lost Hours']) || null : null,
        confirmedFrequencyPerWeek: r['Confirmed Frequency Per Week'] ? parseFloat(r['Confirmed Frequency Per Week']) || null : null,
        timeConfirmationType: r['Time Confirmation Type'] || '',
      };
    });
